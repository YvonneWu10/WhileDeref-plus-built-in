...
Instance stream_ACC A: Rels.ACCUM (list A) (Stream A) (Stream A) :=
  {|
    Rels.app := @stream_app _;
  |}.

Instance stream_ACC_Nil A: Rels.ACCUM_NIL (list A) :=
  {|
    Rels.nil := @nil _;
  |}.

Instance stream_ACC_LeftId A: ACCUM_LeftId (list A) (Stream A).
Proof.
  constructor.
  intros.
...
Instance stream_ACC_Assoc A: ACCUM_Assoc (list A) (list A) (Stream A) (list A) (Stream A) (Stream A).
Proof.
  constructor.
  intros.
  symmetry.
